...
public:
    ...
    npc_t()  : character_t(){//: character_t('N', 10, 1) {  // Example values passed to character_t constructor
      // Additional initialization for npc_t if needed
      Unique = false;
  }
    ~npc_t(){}
